...
double *mpi_omp_enum_main(int rank, double *mpi_new_array, int num_value_per_process, double *receive_array, int num_of_process, int enum_length, double *enum_array){
		...
		receive_array = start_omp_enum(receive_array, num_value_per_process); //  sort the small array that current process get
 ...
 */
double *start_omp_enum(double *array_enum, size_t array_length){
