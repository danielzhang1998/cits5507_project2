...
double *mpi_omp_quick_main(int rank, double *mpi_new_array, int num_value_per_process, double *receive_array, int num_of_process, int quick_length, double *quick_array, int num_of_thread){
		...
		receive_array = start_omp_quick(receive_array, num_value_per_process, num_of_thread); //  sort the small array that current process get
